...
InodeRef* iref_free(InodeRef *i);

InodeRef* iref_ref(InodeRef *i);
InodeRef* iref_unref(InodeRef *i);
...
int iref_open_full(
                ...
                mode_t mode,
                InodeRef **ret);
static inline int iref_open(InodeRef *i, const char *path, int open_flags, mode_t mode, InodeRef **ret) {
...
int iref_parent(InodeRef *i, InodeRef **ret);
...
int iref_rename(InodeRef *from, const char *from_name, const InodeRef *to, const char *to_name, unsigned flags);
